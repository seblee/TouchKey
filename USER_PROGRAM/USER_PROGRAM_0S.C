...
void USER_PROGRAM_INITIAL()
{
    ...
    /*--remark:-
      ...
      _ct0ck2=1;
      _ct0ck1=1;
      _ct0ck0=1;								// TM0C0[6:4](T0CK[2:0])---TM0 时钟源; 000：Fsys/4; 001:Fsys; 010:Fh/16; 011:Fh/64;
      100&101:Ftbc; 110:TCK0上升沿; 111:TCK0下降沿 _ct0on=0;									//
      TM0C0.3---计数器运行控制位

        //;--------TM0C1
            _ct0m1=1;
            _ct0m0=1;									// TM0C1[7:6](T0M[1:0])---功能选择; 00: 比较匹配输出;
      01：捕捉输入模式; 10: PWM模式; 11:定时计数模式 _ct0io1=0; _ct0io0=0;								//
      TM0C1[5:4](T0IO[1:0])---见规格书; 定时模式未使用. PWM模式---10: PWM输出
            _ct0oc=0;									// TM0C1.3--- 输出脚初始状态; 0: 初始低/低有效； 1:
      初始高/高有效 _ct0pol=0;								// TM0C1.2--- 输出极性; 0： 同相 _ct0dpx=0;
      // TM0C1.1--- 占空比/频率 比较选择; 0： CCRP周期, CCRA=占空比 _ct0cclr=0;								//
      TM0C1.0--- 计数器周期匹配; 0: CCRP匹配; 1: CCRA匹配
