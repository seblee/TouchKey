...
//												
								...
								b_PIN_ST=0;
								if(r_send_buf&0x80) r_SEND_BIT_TIME=7;				// 1: -> LOW 8*125uS 
									else r_SEND_BIT_TIME=3;                     // 0: -> LOW 4*125uS
							}
							else
								{
									b_PIN_ST=1;
									if(r_send_buf&0x80) r_SEND_BIT_TIME=3;				// 1: -> HIGH  4*125uS 
										else r_SEND_BIT_TIME=7;                     // 0: -> HIGH  8*125uS
